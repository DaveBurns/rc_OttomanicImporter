...
_G.LrExportSession = import 'LrExportSession' -- for export-after-import functionality.
...
_G.Ffmpeg = require( "ExternalApps/Ffmpeg" ) -- instance created upon demand, if warranted.
_G.ExifTool = require( "ExternalApps/ExifTool" )
_G.DngConverter = require( "ExternalApps/DngConverter" )
_G.dngConverter = DngConverter:new{ optional="Adobe DNG Converter is required for importing as DNG, otherwise not. Consider downloading and installing a fresh copy from Adobe (internet search for 'Download Adobe DNG Converter' will do it), and then configure in plugin manager (if non-default installation), if you plan to convert files to DNG upon import." }
_G.Convert = require( "ExternalApps/Convert" )
_G.convert = Convert:new{ optional="ImageMagick's convert utility is required for converting from gif to png, otherwise not. Consider downloading and installing a fresh copy from ImageMagick (readily findable via internet search), and then configure in plugin manager, if you plan to convert such files upon import." }
_G.Import = require( "Import" )
_G.exifTool = ExifTool:new()
--_G.ExtendedImport = require( "ExtendedImport" ) ###3 -- I think it would confuse things to introduce yet another way to customize, but maybe in the future...
_G.DevelopSettings = require( "Catalog/DevelopSettings" )
_G.developSettings = DevelopSettings:new{ cleanup=true }
_G.Keywords = require( "Catalog/Keywords" )
_G.keywords = Keywords:new{ initInterval = -1 } -- don't start init task, yet.
_G.Xmp = require( 'Image/Xmp' )
_G.xmp = Xmp:new()
_G.Java = require( "ExternalApps/Java" )
_G.XmlSimple = require( "Data/XmlSimple" )
_G.DirChgApp = require( "ExternalApps/DirChgApp" )
_G.OttomanicImporter = require( "OttomanicImporter" )
...
java = Java:new()
simpleXml = XmlSimple:new()
dirChgApp = DirChgApp:new{ addlNames={ "Background" } } -- OttomanicImporter uses plugin-id for ad-hoc auto-importing, Background task uses extended-id for mirroring and auto-selection.
ottomanic = OttomanicImporter:new()
